...
function setup() {
  ...
  resorte1 = new Resortera(pajaro.body, {x:200, y:100});
  //cuerpos_restringidos = new Chain(pajaro.body, tronco_restringido.body);
